...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha,
        ...
        self.layer1 = nn.Linear(fc1_dims, fc1_dims)
...
class PPOAgent:
    ...
    def train(self,):
        ...
        # print('DEBUG - states_batch.shape, actions_batch.shape, vals_batch.shape', states_batch.shape, actions_batch.shape, vals_batch.shape)       
